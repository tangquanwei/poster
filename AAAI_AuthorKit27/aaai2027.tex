...
% LaTeX snippet for Experiment 2: Partial-match discrimination.
% Figure asset:
% figures/aaai/partial_match_combined_main.pdf
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{figure/partial_match_combined_main.pdf}
    \caption{
