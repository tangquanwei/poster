...
% --- 标题信息 ---
\title{%
	\parbox[c]{0.18\linewidth}{\raisebox{-0.5\height}{\safeimageheight{6cm}{logo.png}{Logo}}}%
	\parbox[c]{0.64\linewidth}{\centering \textbf{\huge INTERMITTENT SEMI-WORKING MASK: \\ A NEW MASKING PARADIGM FOR LLMs}}%
	\parbox[c]{0.18\linewidth}{\raggedleft\raisebox{-0.5\height}{\safeimageheight{6cm}{ant.png}{Ant}}}%
	}
...
\begin{document}
	...
	\begin{columns}
		...
		\block{\techicon 2. ISM Methodology}{
			...
			\begin{center}
				\includegraphics[width=0.9\linewidth]{image copy.png}
			\end{center}
