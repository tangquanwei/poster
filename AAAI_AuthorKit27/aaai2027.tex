...
We evaluate the systems from two complementary perspectives: hotword detection and candidate ranking. For threshold-based detection, we report precision, recall, and F1 score. 
