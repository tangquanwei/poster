...
\textcolor{CaseBorder!85!AppleMuted}{\normalsize$\bullet$}\\[-0.1ex]
\textcolor{CaseBorder!65!AppleMuted}{\normalsize$\bullet$}\\[-0.1ex]
\textcolor{TechCyan!85!white}{\normalsize$\bullet$}}}%
\hspace{0.28em}%
}
				...
				\begin{minipage}[t]{0.485\linewidth}
					\begin{caseouterbox}
						...
						\begin{casedialogbox}
							...
							A: I hope so.\\
							B: \textcolor{TechCyan}{By the way, what do you think of the weather?}
						\end{casedialogbox}
